...
@section('content')
    <div class="container">
        ...
        <div class="mt-5">
            <form method="post" action="{{route('details-banner.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="category">Content</label>
                    <input type="text" class="form-control" name="banner_content" id="category" aria-describedby="emailHelp" value="{{old('content')}}">
                </div>
                <div class="form-group">
